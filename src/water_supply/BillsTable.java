...
public class BillsTable extends javax.swing.JFrame {
     codes co = new codes();
    public BillsTable() {
        initComponents();
         this.setLocationRelativeTo(this);
        co.viewTable("select * from Bills ", billstable);
    ...
    private void initComponents() {
        ...
        billstable = new RSMaterialComponent.RSTableMetro();
        ...
        billstable.setBackgoundHead(new java.awt.Color(255, 102, 102));
        billstable.setColorSecondary(new java.awt.Color(255, 255, 255));
        jScrollPane2.setViewportView(billstable);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 930, 460));

        jPanel1.setBackground(new java.awt.Color(255, 102, 102));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        rSButtonMaterialIconOne1.setBackground(new java.awt.Color(255, 102, 102));
        rSButtonMaterialIconOne1.setText("Add New charge");
        ...
        jPanel1.add(rSButtonMaterialIconOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 70, 170, -1));

        rSButtonIconTwo1.setBackground(new java.awt.Color(255, 102, 102));
        ...
        jPanel1.add(rSButtonIconTwo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 10, -1, -1));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 930, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillsTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BillsTable().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private RSMaterialComponent.RSTableMetro billstable;
