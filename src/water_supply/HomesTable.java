...
public class HomesTable extends javax.swing.JFrame {
     codes co = new codes();
    public HomesTable() {
        initComponents();
         this.setLocationRelativeTo(this);
        co.viewTable("select * from Homes ", htable);
    ...
    private void initComponents() {
        ...
        htable = new RSMaterialComponent.RSTableMetro();
        ...
        htable.setBackgoundHead(new java.awt.Color(153, 0, 153));
        htable.setColorSecondary(new java.awt.Color(255, 255, 255));
        ...
        rSButtonMaterialIconOne1.setBackground(new java.awt.Color(153, 0, 153));
        rSButtonMaterialIconOne1.setText("Add New Home");
        ...
        rSLabelTextIcon1.setText("Homes");
        rSLabelTextIcon1.setFont(new java.awt.Font("Roboto Bold", 1, 18)); // NOI18N
        rSLabelTextIcon1.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.HOME);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HomesTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HomesTable().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private RSMaterialComponent.RSTableMetro htable;
